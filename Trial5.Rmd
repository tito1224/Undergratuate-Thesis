---
title: "Simulation Results Trial Five"
author: "Tito"
date: "2023-02-09"
...
5 cases did not run because no detections were made, which is fair.
```{r}
...
```{r}
dfHistoryFinal%>%
  filter(combinationNumber==1 & simulationNumber==93)

# i am assuming the detection history was split so much that nothing was detected because a detectionhistory dataframe is not being returned
```
