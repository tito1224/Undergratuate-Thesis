...
such that the last number generated needs to equal to the total point counts at 
...
detection calculated at the end of the interval to find the interval count. 
```{r}
