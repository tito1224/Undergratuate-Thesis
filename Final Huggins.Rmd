...
Load data - don't touch this. Temporarily set the working directory to load the data - will automatically return to current working directory after this chunk runs. 
```{r}
setwd("~/Rcode/Undergratuate-Thesis/DigitalAllianceOutput/Huggins")
...
Some code to add identifiers to the data. Combination number will identify the variables used to create the scenario. Simulation number will identify the datapoints actually generated. There are 1000 simulation numbers for every combination number! The variable `params` is created in one of the code chunks below, and shows the variables associated with each combination number.
...
The params dataset represents the scenarios/environment used to simiulate data for each combination number. Add it to the dataset of final estimates to help calculate summary statistics.
...
Create a dataframe of summarized variables. This is before outliers have been removed btw.
...
The graph below shows us that in order to maximize the log likelihood p needs to be extremely close to 0. The estimator for N (after taking the derivative of the conditional log likelihood wrt to p and setting equal to 0 to find an estimate of $\hat{p}$) is:
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/likelihhod.jpg")
```
...
# dfEstimatesFinalH = dfEstimatesFinalH %>%
...
dfEstimatesProbability = dfEstimatesFinalHUnClean %>%
...
```{r}
1 - (nrow(dfEstimatesFinalH)/nEstimates)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/Population_Estimates_20.jpg")
```
...
ggplot()+
  ...
  labs(x= "Per Minute Detection Probability",y = "Estimate")+
  theme_bw()
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/Population_Estimates_10.jpg")
```
...
For use in a table in the report.
```{r}
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/avg_pop_est.jpg",width=10,height=5)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/avg_pop_est_10_5.jpg",width=10,height=5)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/avg_pop_est_5.jpg",width=10,height=5)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/avg_pop_est_10.jpg",width=10,height=5)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/bias_var_20.jpg",width=10,height=5)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/bias_var_5.jpg",width=10,height=5)
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/interac.jpg")
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/mse.jpg")
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/mse_10.jpg")
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/coverage.jpg")
```
...
ggsave("C:/Users/titom/OneDrive/Documents/Rcode/Undergratuate-Thesis/Images/coverage10.jpg")
```
