...
Test `detectMin` function to check if it works properly (when sourced from `runSimulationFunctions.R`)
...
```{r}
test[!duplicated(test[,c("combinationNumber","C")]),c("combinationNumber","C")]
```
